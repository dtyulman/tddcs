...
\begin{figure}[tb]
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[height=2in]{laser_board_isometric}
    \end{subfigure}~%
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[height=2in]{laser_board_top}
    \end{subfigure}
